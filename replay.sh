...
nohup exchaind replay -d /Users/oker/scf/data/sx-5811000-5813000-rocksdb/data --home /tmp/scf_exchain_data --save_block=true  --deliver-txs-mode=2  --iavl-enable-async-commit=false > scf.log &
